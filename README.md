...
Dont minimize this window, you can click a window behind it, to make it disappear. (Windows doesn't render it, if you minimize it)
...
Rightclick the Window Capture, press on Filters, and add a Chroma Key. Set the Opacity to 0.5 and Contrast to 2.5
...
Everytime you use the Bot you have to Start your Virtual Camera in OBS, so the Bot can get the Image from the Switch.
...
In case of a Disconnect, enter the first Letter of the Tag, and the amount the Person disconnected with, (tells you in Overlay and next to Table). If more than one Person disconnected in a single race, you can check on the Screenshots Tab, to see how much each one disconnected with.
